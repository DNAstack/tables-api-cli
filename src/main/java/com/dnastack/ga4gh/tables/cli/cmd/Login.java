...
import com.dnastack.ga4gh.tables.cli.util.ContextUtil;
...
public class Login extends BaseCmd {
    ...
    private boolean performIdentityLogin() {
        ...
        try {
            ...
            contextDAO.persist(new Context(ddapRootUrl, loginCommand
                .getRealm(), damInfos, loginTokenResponse, basicCredentials));
    ...
    private void getSearchAccess() {
        ...
        try {
            ...
            if (damInfo == null) {
                throw new RuntimeException(String.format("Invalid damId [%s]\n", damId));
            }
            ...
            ConfigUtil.getUserConfig().addApiToken(response.getToken());
            ConfigUtil.save();
